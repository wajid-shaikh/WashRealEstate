  ...
  return (
    <>
      ...
      <section id="home" className="relative h-screen">
        ...
        ></div>
        <div className=" mx-5 md:mx-20 lg:mx-20 xl:mx-20 absolute top-1/2 transform -translate-y-1/2">
          ...
          <div className="font-sans font-extrabold text-[60px] text-white w-auto md:w-[550px] lg:w-[600px] xl:w-[700px]  leading-none">
            {HomeSection.HomeBodyText}
          </div>
          <div className="font-sans text-white mt-9 w-auto md:w-[500px] lg:w-[600px] xl:w-[700px] grid grid-cols-1 divide-x-[3px]">
            <div className="  rounded-2xl "></div>
            <div className=" px-4 w-[350px] md:w-full lg:w-full xl:w-full">
              {HomeSection.HomeDescription}
            </div>
          </div>
          <div className=" mt-9 text-center md:text-left lg:text-left xl:text-left">
            <Link
              to={"/property"}
      ...
      <section
        id="aboutus"
        className="mx-5 md:mx-20 lg:mx-20 xl:mx-20 py-10 flex items-center"
      >
        <AboutUs />
      </section>
