  ...
  return (
    <>
      ...
      <section id="home" className="relative h-screen">
        ...
        ></div>
        <div className=" mx-20 absolute top-1/2 transform -translate-y-1/2">
          ...
          <div className="font-sans font-extrabold text-[60px] text-white w-[550px] leading-none">
          ...
          <div className="font-sans text-white mt-9 w-[500px] grid grid-cols-1 divide-x-[3px]">
            ...
            <div className=" px-4"> {HomeSection.HomeDescription}</div>
          </div>
          <div className=" mt-9">
            <Link
              to={"/property"}
      ...
      <section id="aboutus" className="mx-20 py-10 flex items-center">
        <AboutUs />
      </section>
